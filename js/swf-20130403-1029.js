...
function loadMainClient(swfobject) {
	...
	swfobject.embedSWF(config.assetsRoot+config.assetsUrl['/flash/AngryBirdsFacebook.swf'], "flashHolder",
			"100%", "570",
			"11.0.0", config.assetsRoot+config.assetsUrl['/flash/playerProductInstall.swf'],
